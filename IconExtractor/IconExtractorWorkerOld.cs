...
namespace IconExtractor
{
    ...
    /// </summary>
    [Obsolete("A enlever dès que je n'en aurais plus besoin.")]
    sealed class IconExtractorWorkerOld : IDisposable
	{
		...
		public IconExtractorWorkerOld(string source, IconSize size)
		{
			IconSource = source;
			IntPtr[] nullPtr = null;
